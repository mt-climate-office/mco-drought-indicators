...
SMAP Soil Moisture Anomaly {data-navmenu="Soil Moisture" data-icon="fa-list" data-orientation=rows}
========================================================
...
Soil moisture is a strong indicator of drought. In this module we present Soil Moisture Active Passive (SMAP) Level 3 soil moisture anomalies calculated using the NASA-USDA Enhanced SMAP Global soil moisture dataset. For more information, please visit https://developers.google.com/earth-engine/datasets/catalog/NASA_USDA_HSL_SMAP10KM_soil_moisture. 
